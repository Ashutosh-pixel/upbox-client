            ...
            <ul className="navbar-nav main-menu">
                ...
                <li className="nav-item p-1 pl-6 pb-4">
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <Link href="/drive/dashboard">Dashboard</Link>
                    </div>
                </li>
                <li><hr/></li>
                <li className="nav-item static-item p-4">
                ...
                <li className="nav-item p-1 pl-6">
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <Link href="/drive/image">Image</Link>
                    </div>
                </li>
                <li className="nav-item p-1 pl-6">
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <Link href="/drive/video">Video</Link>
                    </div>
                </li>
                <li className="nav-item p-1 pl-6">
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <Link href="/drive/document">Document</Link>
                    </div>
                </li>
                <li className="nav-item p-1 pl-6">
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <Link href="/drive/files">All Files</Link>
                    </div>
                </li>
                <li className="nav-item p-1 pl-6 pb-4">
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <Link href='/drive/trash'>Trash</Link>
                    </div>
                </li>
                <li><hr/></li>
                <li className="nav-item static-item p-4">
