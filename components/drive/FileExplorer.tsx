...
const FileExplorer: React.FC<FileExplorerProps> = ({ fileType = 'all' }) => {
    ...
    return (
        <div className="p-6">
            ...
            <FolderContainer key={parentId} parentID={parentId} folderResponse={folderResponse} fileType={fileType} />
            <FileContainer
                parentID={parentId}
